...
const WorldNewsPage = () => {
  ...
  return loader ? (
    ...
    <div className="main-container">
      ...
      <div className="left-section-item active" onClick={(e)=>{navigate('') ;handleClick(e)}}>
        ...
        <div className="left-section-item" onClick={(e)=>{navigate("sports") ;handleClick(e)}}>
            <svg
              fill="white"
        ...
        <div className="left-section-item" onClick={(e)=>{ navigate("entertainment"); handleClick(e)}}>
            <svg
              fill="white"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
        ...
        <div className="left-section-item" onClick={(e)=>{ navigate("technology"); handleClick(e)}}>
            <svg
              fill="white"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
        ...
        <div className="left-section-item" onClick={(e)=>{ navigate("education"); handleClick(e)}}>
            <svg
              fill="white"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
        ...
        <div className="left-section-item" onClick={(e)=>{ navigate("gaming"); handleClick(e)}}>
            <svg
              fill="white"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
